...
- [นิยามศัพท์เฉพาะ (Definition of Terms)](#definition-of-terms)
...
<a id="definition-of-terms"></a>
## 📘 นิยามศัพท์เฉพาะ (Definition of Terms)

| คำศัพท์ | คำอธิบาย |
| :--- | :--- |
| **Pass-Through Rate (อัตราการส่งผ่านราคา)** | สัดส่วนการส่งผ่านการเปลี่ยนแปลงของต้นทุนน้ำมันไปเป็นการเปลี่ยนแปลงของราคาตั๋วเครื่องบิน ใช้เพื่อวัดระดับการตอบสนองของราคาตั๋วต่อราคาน้ำมัน |
| **Fuel Surcharge (ค่าธรรมเนียมน้ำมันเชื้อเพลิง)** | ค่าธรรมเนียมส่วนเพิ่มที่สายการบินเรียกเก็บแยกจากราคาตั๋วพื้นฐาน เพื่อช่วยชดเชยความเสี่ยงจากความผันผวนของราคาน้ำมัน |
| **Base Fare (ราคาตั๋วพื้นฐาน)** | ราคาค่าเดินทางพื้นฐานของสายการบิน ก่อนรวมภาษี ค่าธรรมเนียมสนามบิน และค่าธรรมเนียมน้ำมันเชื้อเพลิง |
| **Flag Carrier / Full-Service Carrier: FSC (สายการบินประจำชาติ / สายการบินบริการเต็มรูปแบบ)** | สายการบินที่ให้บริการสิทธิประโยชน์ค่อนข้างครบถ้วน มักมีเครือข่ายเส้นทางระยะไกล (Long-Haul) และมีโครงสร้างต้นทุนการดำเนินงานที่สูงกว่าสายการบินต้นทุนต่ำ |
| **Low-Cost Carrier: LCC (สายการบินต้นทุนต่ำ)** | สายการบินที่เน้นลดต้นทุนและตัดบริการที่ไม่จำเป็นออก เพื่อเสนอราคาตั๋วที่ต่ำลง โดยมักให้บริการเส้นทางระยะสั้นถึงระยะกลาง |
| **Load Factor / Passenger Load Factor (อัตราส่วนการครองที่นั่ง)** | สัดส่วนจำนวนที่นั่งที่มีผู้โดยสารใช้งานจริงเทียบกับจำนวนที่นั่งทั้งหมดที่เปิดขายในเที่ยวบิน คิดเป็นเปอร์เซ็นต์ |
| **Route-Months (เส้นทาง-เดือน)** | หน่วยวัดผลกระทบเชิงปฏิบัติการ โดย 1 Route-Month หมายถึง 1 เส้นทางบินที่ได้รับผลกระทบเป็นระยะเวลา 1 เดือน |
| **Brent Crude (น้ำมันดิบเบรนท์)** | ราคาน้ำมันดิบมาตรฐานอ้างอิงระดับสากลจากทะเลเหนือ ซึ่งใช้เป็นราคาอ้างอิงสำคัญในยุโรป ตะวันออกกลาง และเอเชีย |
| **Jet Fuel (น้ำมันเชื้อเพลิงเครื่องบิน)** | น้ำมันก๊าดคุณภาพสูง (Kerosene-type fuel) ที่ผ่านการกลั่นสำหรับใช้เป็นเชื้อเพลิงของเครื่องบินไอพ่นพาณิชย์ |
| **Crack Spread / Refinery Margin (ส่วนต่างราคาน้ำมันกลั่น / ค่าการกลั่น)** | ส่วนต่างระหว่างราคาผลิตภัณฑ์น้ำมันสำเร็จรูป เช่น Jet Fuel กับราคาน้ำมันดิบ Brent ซึ่งสะท้อนภาวะตึงตัวของอุปทานและส่วนต่างจากกระบวนการกลั่น |
| **Fuel Hedging (การประกันความเสี่ยงราคาน้ำมัน)** | การใช้สัญญาทางการเงินเพื่อล็อกหรือจำกัดระดับราคาน้ำมันล่วงหน้า เพื่อลดความเสี่ยงจากการปรับขึ้นของราคาน้ำมันในอนาคต |
| **Hedge Ratio / Fuel Hedging % (สัดส่วนการประกันราคาน้ำมัน)** | สัดส่วนของปริมาณน้ำมันที่สายการบินนำไปทำสัญญาป้องกันความเสี่ยงล่วงหน้า เทียบกับปริมาณน้ำมันที่ใช้ทั้งหมดในช่วงเวลานั้น |
| **Hedge Savings (เงินประหยัดจากการประกันราคาน้ำมัน)** | มูลค่าที่สายการบินประหยัดได้จากการทำ Fuel Hedging เมื่อราคาน้ำมันในตลาดสูงกว่าราคาหรือระดับที่กำหนดไว้ในสัญญา |
| **Break-Even Brent Price (จุดคุ้มทุนราคาน้ำมันดิบ Brent)** | ระดับราคาน้ำมันดิบ Brent สูงสุดที่สายการบินสามารถรับได้ ก่อนที่ผลประกอบการสุทธิจะเปลี่ยนจากกำไรเป็นขาดทุน |
| **Time Lag / Lag (ระยะเวลาหน่วง)** | ระยะเวลาที่ผลลัพธ์เกิดขึ้นหลังจากเหตุการณ์ต้นเหตุในข้อมูลอนุกรมเวลา เช่น Lag 0 หมายถึงเกิดผลในเดือนเดียวกัน และ Lag 5 หมายถึงเกิดผลในอีก 5 เดือนถัดมา |
| **Cross-Correlation Analysis (การวิเคราะห์ความสัมพันธ์ไขว้)** | การวิเคราะห์ความสัมพันธ์ระหว่างข้อมูลสองชุดเมื่อเลื่อนช่วงเวลา (Lag) เพื่อดูทั้งระดับความสัมพันธ์และช่วงเวลาที่การเปลี่ยนแปลงของตัวแปรหนึ่งสัมพันธ์กับอีกตัวแปรหนึ่ง |
| **Percentage Points: pp (จุดเปอร์เซ็นต์)** | หน่วยวัดผลต่างระหว่างค่าร้อยละสองค่า เช่น Net Profit Margin เปลี่ยนจาก -24.5% เป็น -16.4% เท่ากับเพิ่มขึ้น **8.1 percentage points** |
...
### คำถามวิจัยหลัก (Main Research Question)
**ความผันผวนของราคาน้ำมันจากเหตุการณ์ทางภูมิรัฐศาสตร์ ส่งผลต่อราคาตั๋วเครื่องบินและความสามารถในการรับมือของธุรกิจสายการบินอย่างไร?**

### ส่วนที่ 1: ผลกระทบต่อตลาดและการส่งผ่านราคาตั๋วเครื่องบิน (Market Impact & Airfare Transmission)

- **Q1: ความเร็วในการส่งผ่านและโครงสร้าง Lag (Transmission Speed & Lag Structure)**  
  *ความผันผวนของราคาน้ำมันดิบจากเหตุการณ์ทางภูมิรัฐศาสตร์ ส่งผ่านไปยังราคาตั๋วเครื่องบินเร็วเพียงใด และมีระยะเวลาหน่วง (Time Lag) เท่าใด?*
- **Q2: ขนาดการส่งผ่านและความแตกต่างระหว่างวิกฤต (Pass-Through Magnitude & Crisis Differences)**  
  *ผลกระทบของราคาน้ำมันต่อราคาตั๋วเครื่องบินมีขนาดแตกต่างกันหรือไม่ในแต่ละวิกฤต เช่น COVID-19 สงครามรัสเซีย-ยูเครน และวิกฤตอิหร่าน 2025–2026?*
- **Q3: ความรุนแรงของเหตุการณ์และผลกระทบต่อตลาด (Event Severity & Market Impact)**  
  *เหตุการณ์ทางภูมิรัฐศาสตร์ที่มีความรุนแรงสูงกว่า ส่งผลกระทบต่อราคาน้ำมันและราคาตั๋วเครื่องบินมากกว่าหรือไม่?*
- **Q4: โมเดลธุรกิจสายการบินและการส่งผ่านต้นทุน (Airline Business Model & Cost Pass-Through)**  
  *สายการบินบริการเต็มรูปแบบ (FSC) และสายการบินต้นทุนต่ำ (LCC) มีการตอบสนองและส่งผ่านต้นทุนจากความผันผวนของราคาน้ำมันแตกต่างกันหรือไม่?*

### ส่วนที่ 2: ความสามารถในการรับมือและผลกระทบต่อธุรกิจสายการบิน (Airline Resilience & Business Impact)

- **Q5: ประสิทธิภาพของการประกันความเสี่ยงราคาน้ำมัน (Fuel Hedging Effectiveness)**  
  *การทำ Fuel Hedging ช่วยลดผลกระทบจากราคาน้ำมันและปกป้องผลกำไรของสายการบินได้มากเพียงใด?*
- **Q6: ผลกระทบจากการหยุดชะงักของน่านฟ้า (Airspace Disruption Impact)**  
  *การหยุดชะงักของน่านฟ้าสร้างต้นทุนด้านการดำเนินงานและผลกระทบทางการเงินต่อสายการบินอย่างไร?*
- **Q7: ราคาน้ำมันดิบและจุดคุ้มทุนของสายการบิน (Airline Break-Even Brent Crude Prices)**  
  *ราคาน้ำมันดิบสามารถเพิ่มขึ้นได้ถึงระดับใดก่อนที่สายการบินจะเริ่มขาดทุน และการทำ Fuel Hedging ช่วยเพิ่มส่วนเผื่อราคาน้ำมัน (Headroom) ได้มากเพียงใด?*
...
* [ภาพที่ 1: ภาพรวมไทม์ไลน์ความสัมพันธ์ระหว่างราคาน้ำมันดิบ โครงสร้างราคาตั๋วเครื่องบิน และอัตราการเปลี่ยนแปลงรายเดือน ในช่วงปี 2019–2026 (แสดงความสัมพันธ์เชิงเวลาระหว่างราคาน้ำมันดิบ Brent และ ราคาน้ำมันเครื่องบิน Jet Fuel กับราคาตั๋วเครื่องบินรวม, ราคาตั๋วพื้นฐาน และค่าธรรมเนียมน้ำมัน จำแนกตาม 9 ช่วงวิกฤตการณ์)](file:///c:/Users/P/oil%20situation/fig1_timeline_overview.png)
...
กราฟกระจายตัวแสดงความสัมพันธ์ระหว่าง ราคาน้ำมันดิบ (แกน X) กับ ราคาตั๋วเครื่องบินรวม (แกน Y) ของทุกเดือน** 
 - กราฟความสัมพันธ์แบบ Scatter Regression แสดงความสัมพันธ์เชิงเส้นเป็นบวกที่แข็งแกร่งระหว่างราคาน้ำมัน Brent ($/บาร์เรล) และราคาตั๋วเครื่องบินเฉลี่ย ($) ($r = +0.872$)
...
Iran Crisis (สีแดง):ทะยานพุ่งสูงถึงเฉลี่ยเกือบ $3,000(2,980) ในเดือนที่ 4 (สูงเป็น 3 เท่าของระดับปกติที่ $1,000)

- ค่าธรรมเนียมเชื้อเพลิง Fuel Surcharge (ขวาบน):
Iran Crisis (สีแดง): ทะลุ $515 ในเดือนที่ 4 ทำสถิติสูงสุดเป็นประวัติการณ์
...
- ภาระความเสียหายรวมทั้งอุตสาหกรรม: $12,639,369 (12.64 ล้านเหรียญสหรัฐ) คิดจากสายการบิน 22 แห่ง
จำนวนเส้นทางบินที่ถูกยกเลิกสะสม: 52 รูท/เดือน

(a)(กราฟด้านซ้าย) Absolute Burden — ภาระความเสียหายในรูปมูลค่าเงินจริง ($)
...
(b)(กราฟด้านขวา) Normalised Burden — ภาระความเสียหายเฉลี่ยต่อเส้นทางบิน ($/รูท/เดือน)

- คำถาม: "สายการบินตะวันออกกลางเสียหายหนักกว่าสายการบินอื่นจริงหรือไม่?"
- คำตอบ: "ไม่จริง" เมื่อปรับสเกลตามจำนวนเส้นทางบินแล้ว สายการบินตะวันออกกลาง (ป้ายสีแดง) มีภาระความเสียหายเฉลี่ยอยู่ที่ $40,962/รูท/เดือน ซึ่งต่ำกว่าสายการบินนอกตะวันออกกลาง(ป้ายสีดำ)ที่มีภาระเฉลี่ยถึง $47,812/ รูท/เดือน
...
(c)(กราฟด้านซ้าย) Monthly Timeline — ไทม์ไลน์รายเดือนและการผ่อนคลายความตึงเครียด
   ...
   - กราฟแท่งแนวนอนแสดงระยะทางบินอ้อมเพิ่มเฉลี่ยต่อเที่ยวบิน (กิโลเมตร) และค่าน้ำมันส่วนเพิ่มต่อเที่ยวบิน (+$/เที่ยวบิน):

   - เส้นทางที่บินอ้อมหนักที่สุด: เส้นทาง Abu Dhabi → Chicago (Etihad Airways) ต้องบินอ้อมเพิ่มขึ้นถึง ~1,550 กิโลเมตร/เที่ยว เพิ่มค่าน้ำมันสูงถึง +$5,830 ต่อเที่ยวบิน

   - เส้นทางบินของไทยได้รับผลกระทบจากค่าน้ำมันอ้อม: เส้นทาง กรุงเทพฯ → ลอนดอน (การบินไทย) ติดอันดับ 10 ของโลกที่ต้องบินอ้อมหลบพื้นที่ตึงเครียดเพิ่มขึ้นถึง 940 กิโลเมตรต่อเที่ยว ส่งผลให้มีค่าน้ำมันส่วนเพิ่มเกิดขึ้นประมาณ $3,443  (ราว 1.2 แสนบาท) ต่อหนึ่งเที่ยวบิน
...
- ในไตรมาส 2026-Q1 (ช่วงวิกฤตสงครามอิหร่าน) ราคาน้ำมันดิบ Brent เฉลี่ยพุ่งขึ้นไปถึง $131/bbl (เส้นประแนวตั้งสีดำ) ส่งผลให้จาก 25 สายการบินชั้นนำทั่วโลก มีเพียง 4 สายการบินเท่านั้นที่ยังคงทำกำไรอยู่ได้ ส่วนอีก 21 สายการบินที่เหลือต้องตกอยู่ในภาวะขาดทุน
